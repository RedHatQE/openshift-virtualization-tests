...
class NodeNetworkConfigurationPolicy(Nncp):
    ...
    def wait_for_status_success(self) -> dict[str, Any]:
        self.logger.info(f"Inside wait_for_status_success. nncp instance: {self.instance}")
        self.logger.info(f"conditions in beginning: {[condition for condition in self.instance.status.conditions]}")
        conditions = (
            condition
        ...
        self.logger.info("Inside wait_for_status_success, out of for loop")
        return {}
