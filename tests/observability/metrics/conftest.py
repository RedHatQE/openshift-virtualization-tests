...
@pytest.fixture()
def xfail_if_memory_metric_has_bug(cnv_vmi_monitoring_metrics_matrix__function__):
    if cnv_vmi_monitoring_metrics_matrix__function__ in METRICS_WITH_WINDOWS_VM_BUGS and is_jira_open(
        jira_id="CNV-59679"
    ):
        pytest.xfail(
