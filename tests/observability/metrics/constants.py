...
KUBEVIRT_VMI_PHASE_COUNT = (
    ...
    "{{node='{node_name}', instance_type= '{instance_type}', guest_os_name='{os_name}'}}"
)
...
METRIC_SUM_QUERY = "sum({metric_name}{{instance_type='{instance_type_name}', guest_os_name='{os_name}'}})"
