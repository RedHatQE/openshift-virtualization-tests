...
def validate_vmi_node_cpu_affinity_with_prometheus(
    prometheus: Prometheus, vm: VirtualMachineForTests, windows=False
) -> None:
    vm_cpu = vm.vmi.instance.spec.domain.cpu if windows else vm.instance.spec.template.spec.domain.cpu
