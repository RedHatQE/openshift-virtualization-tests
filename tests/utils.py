...
@contextmanager
def create_windows2022_dv_dict_from_registry(
    dv_name: str,
    namespace: str,
    client: DynamicClient,
    storage_class: str,
...
def create_windows2022_vm_with_vtpm(
    ...
    Args:
        ...
        dv_dict: DataVolume template dictionary with metadata and spec (can be None)
    ...
    if dv_dict is not None and dv is not None:
        raise ValueError("dv_dict and dv cannot be provided together")
