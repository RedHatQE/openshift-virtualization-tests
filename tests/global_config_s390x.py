...
from utilities.os_utils import generate_instance_type_os_matrix, generate_os_matrix_dict
...
instance_type_rhel_os_matrix = generate_instance_type_os_matrix(os_name="rhel", preferences=["rhel.9"])
