...
def test_no_new_cnv_daemonset_added(sno_cluster, cnv_daemonset_names, deploy_passt_network_binding):
    """
    ...
    if deploy_passt_network_binding:
        cnv_daemonsets.append(PASST_BINDING_CNI)
