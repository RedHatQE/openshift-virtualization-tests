...
HCO_DEFAULT_FEATUREGATES: list[dict[str, str]] = []
HCO_V1BETA1_DEFAULT_FEATUREGATES = {  # skip-unused-code
...
FG_STATE_ENABLED = "Enabled"
FG_STATE_DISABLED = "Disabled"  # skip-unused-code
