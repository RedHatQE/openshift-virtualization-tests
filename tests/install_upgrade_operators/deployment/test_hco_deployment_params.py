...
def test_cnv_deployment_priority_class_name(
    ...
    elif cnv_deployment_by_name.name == VIRT_PLATFORM_AUTOPILOT and jira_88756_open:
        pytest.xfail(f"{VIRT_PLATFORM_AUTOPILOT} deployment has no priority class name due to CNV-88756 bug")
