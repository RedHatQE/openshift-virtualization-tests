...
from tests.infrastructure.golden_images.utils import get_storage_class_from_matrix_different_from_data_source
...
def fedora_vm_from_data_source(
    ...
    storage_class = (
        get_storage_class_from_matrix_different_from_data_source(data_source=fedora_data_source)
        if request.param.get("set_storage_class")
        else None
    )
    if request.param.get("set_storage_class") and storage_class is None:
