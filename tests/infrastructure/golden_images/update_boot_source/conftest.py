...
@pytest.fixture()
def first_pvc_in_namespace(unprivileged_client, data_import_cron_namespace):
    """Return first PVC in namespace."""
    return list(
...
@pytest.fixture()
def created_persistent_volume_claim(unprivileged_client, first_pvc_in_namespace):
    try:
        for sample in TimeoutSampler(
            wait_timeout=TIMEOUT_1MIN,
            sleep=TIMEOUT_5SEC,
            func=first_pvc_in_namespace,
