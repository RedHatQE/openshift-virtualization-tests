...
class TestVMFeatures:
    ...
    def test_efi_secureboot_enabled_initial_boot(self, golden_image_vm_with_instance_type):
        assert_dmesg(
            vm=golden_image_vm_with_instance_type, dmesg_pattern="secureboot", expected_status="secure boot enabled"
        )
    ...
    def test_efi_secureboot_enabled_guest_os(self, golden_image_vm_with_instance_type):
        assert_secure_boot_mokutil_status(vm=golden_image_vm_with_instance_type, expected_status="secureboot enabled")
