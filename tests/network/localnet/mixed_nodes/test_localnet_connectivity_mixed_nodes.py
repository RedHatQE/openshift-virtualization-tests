...
Preconditions:
    ...
    - Server VM connected to a localnet network, running on an RHCOS 9 worker node
    - Client VM connected to a localnet network, running on an RHCOS 9 worker node
...
def test_connectivity_over_localnet_preserved_during_client_migration():
    """
...
def test_connectivity_over_localnet_preserved_during_server_migration():
    """
