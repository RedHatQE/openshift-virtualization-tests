...
from libs.net.vmspec import lookup_iface_status, wait_for_iface_status_deleted
...
def hot_plug_interface(
    ...
    lookup_iface_status(
        ...
        predicate=lambda interface: "guest-agent" in interface["infoSource"] and interface["linkState"] == "up",
...
def hot_unplug_interface(vm, hot_plugged_interface_name):
    ...
    wait_for_iface_status_deleted(vm=vm, interface_name=hot_plugged_interface_name, wait_timeout=TIMEOUT_2MIN)
