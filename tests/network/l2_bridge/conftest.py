...
VMA_MPLS_LOOPBACK_IP = random_ipv4_address(net_seed=5, host_address=1, subnet_length=32)
VMA_MPLS_ROUTE_TAG = 100
VMB_MPLS_LOOPBACK_IP = random_ipv4_address(net_seed=6, host_address=1, subnet_length=32)
