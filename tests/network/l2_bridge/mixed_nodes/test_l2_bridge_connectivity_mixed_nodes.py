...
Preconditions:
    ...
    - Server VM connected to a Linux bridge network, running on an RHCOS 9 worker node
    - Client VM connected to a Linux bridge network, running on an RHCOS 9 worker node
...
def test_connectivity_over_linux_bridge_preserved_during_client_migration():
    """
...
def test_connectivity_over_linux_bridge_preserved_during_server_migration():
    """
