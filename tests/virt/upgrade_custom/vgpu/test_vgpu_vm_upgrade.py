...
class TestUpgradeVGPU:
    ...
    def test_vgpu_vm_before_upgrade(self, supported_gpu_device, vgpu_on_nodes, rhel_vm_for_upgrade_session_scope):
    ...
    def test_vgpu_vm_after_upgrade(self, supported_gpu_device, vgpu_on_nodes, rhel_vm_for_upgrade_session_scope):
        running_vm(vm=rhel_vm_for_upgrade_session_scope, wait_for_cloud_init=True)
        verify_gpu_device_exists_in_vm(vm=rhel_vm_for_upgrade_session_scope, supported_gpu_device=supported_gpu_device)
