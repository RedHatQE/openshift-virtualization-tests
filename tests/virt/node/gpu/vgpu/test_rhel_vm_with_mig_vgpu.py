...
@pytest.mark.usefixtures("update_cluster_policy_to_enable_mig_vgpu", "update_daemon_set_to_enable_mig_vgpu")
class TestMIGVGPURHELGPUSSpec:
    ...
    # test_access_mig_vgpus_rhel_vm must run before test_access_vgpus_in_both_rhel_vm_using_same_mig_gpu
    # because the second test reuses the running VM created by the first test.
