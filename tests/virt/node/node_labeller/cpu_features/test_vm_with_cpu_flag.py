...
@pytest.fixture()
def cpu_flag_vm_positive(cluster_common_node_cpu, namespace, local_unprivileged_client):
...
def cpu_flag_vm_negative(request, local_unprivileged_client, namespace):
