...
pytestmark = [
    ...
    pytest.mark.usefixtures("postcopy_migration_bug_xfail", "created_post_copy_migration_policy"),
...
def postcopy_migration_bug_xfail(is_postcopy_migration_bug_open):
