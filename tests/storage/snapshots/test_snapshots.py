...
from tests.storage.snapshots.utils import (
    ...
    start_restored_vm_and_assert_disk_count,
    start_restored_vms_and_assert_disk_counts,
...
class TestRestoreMultiDiskPerformance:
    ...
    def test_restore_vm_with_4_disks_completes_within_five_minutes(
        ...
        start_restored_vm_and_assert_disk_count(vm=vm_with_4_disks_for_snapshot)
    ...
    def test_restore_four_vms_with_4_disks_completes_within_five_minutes(
        ...
        start_restored_vms_and_assert_disk_counts(vms=four_vms_with_4_disks_for_snapshot)
