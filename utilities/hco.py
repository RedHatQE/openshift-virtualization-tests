...
def _hco_node_placements(hco_spec: dict) -> dict:
    return hco_spec.get("deployment", {}).get("nodePlacements", {})
...
def apply_np_changes(
    ...
    node_placements = _hco_node_placements(hco_spec=hco.instance.to_dict()["spec"])
