...
KUBEVIRT_WORKQUEUE_QUEUE_DURATION_SECONDS = "kubevirt_workqueue_queue_duration_seconds"
KUBEVIRT_WORKQUEUE_WORK_DURATION_SECONDS = "kubevirt_workqueue_work_duration_seconds"
