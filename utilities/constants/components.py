...
CLUSTERROLE_STR = "ClusterRole"
CLUSTERROLEBINDING_STR = "ClusterRoleBinding"
MUTATINGWEBHOOKCONFIGURATION_STR = "MutatingWebhookConfiguration"
PODDISRUPTIONBUDGET_STR = "PodDisruptionBudget"
...
ALL_HCO_RELATED_OBJECTS = [
    ...
    {f"{VIRT_NETWORK_RESOURCES_INJECTOR}-pdb": PODDISRUPTIONBUDGET_STR},
    {VIRT_NETWORK_RESOURCES_INJECTOR: CLUSTERROLE_STR},
    {f"{VIRT_NETWORK_RESOURCES_INJECTOR}-service": SERVICE_STR},
    {f"{VIRT_NETWORK_RESOURCES_INJECTOR}-role-binding": CLUSTERROLEBINDING_STR},
    {f"{VIRT_NETWORK_RESOURCES_INJECTOR}-sa": SERVICEACCOUNT_STR},
    {f"{VIRT_NETWORK_RESOURCES_INJECTOR}-config": MUTATINGWEBHOOKCONFIGURATION_STR},
    {VIRT_NETWORK_RESOURCES_INJECTOR: DEPLOYMENT_STR},
]
