...
def remove_tests_from_list(items: list[pytest.Item], filter_str: str) -> tuple[list[pytest.Item], list[pytest.Item]]:
    """Split test items into discarded and kept lists based on a keyword.

    Args:
        items: Collected test items.
        filter_str: Keyword to match against each item's keywords.

    Returns:
        Tuple of (discarded items, kept items).
    """
